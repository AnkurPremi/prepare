...
public class EditDistance {
    ...
    public static void main(String[] args) {
        String s = "horsaasdhorsaahorsaasdasdasdasdaehorsaasda";
        String p = "rasdasdhhorsaasdasdasdasdaehorsaasdasdasdasd";
        System.out.println(new EditDistance().minCount(s, p));
    }
